...
@Getter
public enum StatisticsPageButton implements PageButton {
    ...
    StatisticsPageButton(String titlePropertyName, String reference) {
    ...
    public String getPageReference() {
        return PageConstants.StatisticsPage.PAGE_REFERENCE;
    }
}
